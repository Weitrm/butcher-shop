...
import { useCurrentOrder } from "@/shop/hooks/useCurrentOrder";
...
export const OrderPage = () => {
  ...
  const { data: currentOrder, isLoading: isCurrentLoading } = useCurrentOrder(
    items.length === 0,
  );
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      await queryClient.invalidateQueries({ queryKey: ["orders", "current"] });
              ...
              <CardContent className="p-6 space-y-4">
                ...
                <div className="flex items-center justify-between text-sm">
                  ...
                  <span className="font-semibold">
                    ${currentOrder.totalPrice} ({currentOrder.totalKg} kg)
                  </span>
                </div>
              </CardContent>
            </Card>
